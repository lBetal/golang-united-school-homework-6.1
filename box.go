...
func (b *box) AddShape(shape Shape) error {
	if len(b.shapes) >= b.shapesCapacity {
		return errors.New("case it goes out of the shapesCapacity range")
	}
...
func (b *box) ExtractByIndex(i int) (Shape, error) {
	shapeByIndex, err := b.GetByIndex(i)
	if err != nil {
		return nil, err
	}
